#!/usr/bin/env bash
#BSUB -J PREM3S_SRC014_B0_control
#BSUB -q serial
#BSUB -n 1
#BSUB -R "span[hosts=1]"
#BSUB -L /bin/bash
...
[[ -d "/scratch/yiy/ulvz/SRC014_B0/DATABASES_MPI/" && -w "/scratch/yiy/ulvz/SRC014_B0/DATABASES_MPI/" ]]
