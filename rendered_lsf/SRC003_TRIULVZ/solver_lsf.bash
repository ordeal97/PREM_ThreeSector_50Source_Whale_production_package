#BSUB -J PREM3S_SRC003_TRIULVZ_solver
#BSUB -q mpi
#BSUB -n 384
...
mpirun --prefix "$OMPI_HOME" -np "${LSB_DJOB_NUMPROC:-384}" --hostfile "$HOSTFILE" --map-by ppr:64:node --bind-to core --mca pml ucx --mca btl '^openib' -x LD_LIBRARY_PATH "./bin/xspecfem3D"
